...
## Environments
- Preview: https://main--gabrielwalt-pictet-fr--aemysites.aem.page/
- Live: https://main--gabrielwalt-pictet-fr--aemysites.aem.live/
- Block Library: https://main--gabrielwalt-pictet-fr--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `gabrielwalt-pictet-fr` directory in your favorite IDE and start coding :)
